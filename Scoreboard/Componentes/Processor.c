...
void add(int destination_register, int source_register1, int source_register2) 
{
    ...
    aluResult = registers[source_register1].value + registers[source_register2].value ;
...
void subtract(int destination_register, int source_register1, int source_register2) 
{
    // Mark destination and source registers as in use
    registers[destination_register].writeInProgress = true ;
    registers[source_register1].readInProgress = true ;
...
bool allRegistersFree(struct Register registers[]) 
{
...
bool isFunctionalUnitFree(bool functionalUnits[], int unit) 
{
    return !functionalUnits[unit] ;
}

// Function to mark a functional unit as occupied
void occupyFunctionalUnit(bool functionalUnits[], int unit) 
{
    functionalUnits[unit] = true ; 
}

// Function to release a functional unit
void releaseFunctionalUnit(bool functionalUnits[], int unit) 
{
